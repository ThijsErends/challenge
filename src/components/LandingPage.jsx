      ...
      <div className={styles.content}>
        ...
        <div className={styles.welcomeMessage}>
          ...
          <p className={styles.glitchText}>
            Ik ben Glitch, de geest van dit digitale labyrint. Een kostbare 3-Cijferige Code is verborgen binnen deze muren. Bewijs je waarde door mijn 10 puzzels op te lossen.
          </p>
